    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setTokenData(responseData.volume);
            } catch (error) {
            ...
            <div className="flex flex-col justify-between flex-grow">
                <div className="mb-2 flex items-center justify-start">
                    <div className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#21d3cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20v-6M6 20V10M18 20V4"/></svg>
                        <h2 className="text-lg font-semibold text-gray-200 ml-2">24Hrs Volume</h2>
                    </div>
